...
@section('content')
    <div class="card shadow-1">
        <div class="card-body">
            <h4 class="card-title my-3 fw-bold fs-3">Add Return</h4>
            @if ($errors->any())
            ...
            @endif
            <form id="addProduct" method="POST" action="{{ route('returns.store') }}">
                @csrf
                <div class="row">
                    <!-- Product Name -->
                    <div class="col-md-6">
                ...
                <div class="d-flex justify-content-start">
                    <button type="submit" class="btn btn-primary mx-1">return</button>
